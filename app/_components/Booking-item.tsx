  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Card className="min-w-full">
          <CardContent className="py-0 px-0 flex">
            ...
            <div className="flex flex-col items-center justify-center flex-1 border-l border-secondary">
      ...
      <SheetContent className="px-0">
        ...
        <div className="px-5">
          <div className="relative h-[11.25rem] w-full mt-6">
              ...
              <AlertDialogContent className="w-[90%]">
                ...
                <AlertDialogFooter className="flex-row gap-3">
                  ...
                  <AlertDialogAction disabled={isDeleteLoading} className="w-full" onClick={handleCancelClick}>
                    {isDeleteLoading && <Loader2 className="mr-2 h-4 w-4" />} Confirmar
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
            </AlertDialog>
